...
- [ ] **U3** — Dates de naissance dans les shards (`--bios-only`). L'API n'était pas joignable au moment de la refonte ; sans `bd`, l'âge, le tri par âge et la tuile « âge moyen » se masquent tout seuls. À relancer quand le réseau le permet, aucun changement de code requis.
